...
export const AvatarGallery = {
  render: () => (
    <div className="space-y-6">
      <section>
        ...
        <div className="flex items-center gap-4">
          <Avatar className="h-8 w-8">
            <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
            <AvatarFallback className="text-body-xs">CN</AvatarFallback>
          </Avatar>
          <Avatar>
            <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
            <AvatarFallback>CN</AvatarFallback>
      ...
      <section>
        <h2 className="text-label-md font-semibold mb-3 text-muted-foreground">Fallback Only</h2>
        <div className="flex items-center gap-4">
          <Avatar className="h-8 w-8">
            <AvatarFallback className="text-body-xs">JD</AvatarFallback>
          </Avatar>
          <Avatar>
            <AvatarFallback>JD</AvatarFallback>
          </Avatar>
          <Avatar className="h-16 w-16">
            <AvatarFallback className="text-body-lg">JD</AvatarFallback>
          </Avatar>
        </div>
      </section>
    </div>
