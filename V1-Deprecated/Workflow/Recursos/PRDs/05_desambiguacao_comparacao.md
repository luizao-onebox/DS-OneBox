...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Operações / Desambiguação / Comparação");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Operações / Desambiguação / Comparação"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Operações / Desambiguação / Comparação";
...
if (bc) await tryFont(bc, "Comparação");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Operações / Desambiguação / Comparação");
if (!_screen) throw new Error("Frame 'Admin / Operações / Desambiguação / Comparação' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Operações / Desambiguação / Comparação
Sidebar ativo: "Desambiguação"
Referência: 3134:3842
