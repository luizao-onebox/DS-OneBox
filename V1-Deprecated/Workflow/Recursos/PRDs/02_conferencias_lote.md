...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Operações / Conferências / Lote");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Operações / Conferências / Lote"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Operações / Conferências / Lote";
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Operações / Conferências / Lote");
if (!_screen) throw new Error("Frame 'Admin / Operações / Conferências / Lote' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Operações / Conferências / Lote
Sidebar ativo: "Conferências"
Referência: 3150:14502
...
PageSection/DataTable: 3415:36051 — COMPONENT_SET (Default/With Pagination/Selectable) — Toolbar+Body+Paginação
```
