...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Operações / Desambiguação / Fila");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Operações / Desambiguação / Fila"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Operações / Desambiguação / Fila";
...
if (bc) await tryFont(bc, "Desambiguação");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Operações / Desambiguação / Fila");
if (!_screen) throw new Error("Frame 'Admin / Operações / Desambiguação / Fila' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Operações / Desambiguação / Fila
Sidebar ativo: "Desambiguação"
Referência: 3134:3719
