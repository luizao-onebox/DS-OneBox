...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Settings / Usuários");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Settings / Usuários"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Settings / Usuários";
...
if (bc) await tryFont(bc, "Usuários");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Settings / Usuários");
if (!_screen) throw new Error("Frame 'Admin / Settings / Usuários' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Settings / Usuários
Sidebar ativo: "Settings"
Referência: 3134:3555
