...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Cadastros / Busca & Lista");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Cadastros / Busca & Lista"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Cadastros / Busca & Lista";
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Cadastros / Busca & Lista");
if (!_screen) throw new Error("Frame 'Admin / Cadastros / Busca & Lista' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Cadastros / Busca & Lista
