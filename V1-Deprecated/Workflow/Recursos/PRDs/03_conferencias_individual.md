...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Operações / Conferências / Individual");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Operações / Conferências / Individual"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Operações / Conferências / Individual";
...
if (bc) await tryFont(bc, "Individual > Caso #4521");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Operações / Conferências / Individual");
if (!_screen) throw new Error("Frame 'Admin / Operações / Conferências / Individual' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Operações / Conferências / Individual
Sidebar ativo: "Conferências"
Referência: 3150:14501
