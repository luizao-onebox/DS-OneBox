...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Settings / Termos & Políticas");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Settings / Termos & Políticas"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Settings / Termos & Políticas";
...
if (bc) await tryFont(bc, "Termos & Políticas");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Settings / Termos & Políticas");
if (!_screen) throw new Error("Frame 'Admin / Settings / Termos & Políticas' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Settings / Termos & Políticas
Sidebar ativo: "Settings"
Referência: 3134:3682
