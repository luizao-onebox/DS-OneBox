...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Auditoria / Qualidade & Performance");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Auditoria / Qualidade & Performance"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Auditoria / Qualidade & Performance";
...
if (bc) await tryFont(bc, "Qualidade & Performance");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Auditoria / Qualidade & Performance");
if (!_screen) throw new Error("Frame 'Admin / Auditoria / Qualidade & Performance' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Auditoria / Qualidade & Performance
Sidebar ativo: "Auditoria"
Referência: 3134:3495
