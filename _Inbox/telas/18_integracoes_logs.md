...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Settings / Integrações / Logs");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Settings / Integrações / Logs"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Settings / Integrações / Logs";
...
if (bc) await tryFont(bc, "Logs por Integração");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Settings / Integrações / Logs");
if (!_screen) throw new Error("Frame 'Admin / Settings / Integrações / Logs' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Settings / Integrações / Logs
Sidebar ativo: "Settings"
Referência: 3134:3121
