...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Settings / Integrações / Status");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Settings / Integrações / Status"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Settings / Integrações / Status";
...
if (bc) await tryFont(bc, "Status & Panic Button");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Settings / Integrações / Status");
if (!_screen) throw new Error("Frame 'Admin / Settings / Integrações / Status' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Settings / Integrações / Status
Sidebar ativo: "Settings"
Referência: 3134:3157
...
Card/Integration Status: 3415:36241 — COMPONENT_SET, variantes Status=Online/Offline/Degraded
Modal/Template: 3415:36387 — COMPONENT_SET preferido (Small 480/Medium 640/Large 800) — usar createInstance()
Modal/Content legado: 3048:14338 — FRAME, usar .clone() se necessário
```
