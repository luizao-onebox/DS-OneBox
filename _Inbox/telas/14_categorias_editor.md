...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Settings / Categorias / Editor");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Settings / Categorias / Editor"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Settings / Categorias / Editor";
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Settings / Categorias / Editor");
if (!_screen) throw new Error("Frame 'Admin / Settings / Categorias / Editor' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Settings / Categorias / Editor
Sidebar ativo: "Settings"
Referência: 3134:3221
...
Form/Field Row: 3415:36275 — COMPONENT_SET (Default/With Helper) — rows de label+input no formulário
```
