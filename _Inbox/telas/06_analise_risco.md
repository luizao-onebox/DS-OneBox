...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Operações / Análise de Risco");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Operações / Análise de Risco"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Operações / Análise de Risco";
...
if (bc) await tryFont(bc, "Análise de Risco");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Operações / Análise de Risco");
if (!_screen) throw new Error("Frame 'Admin / Operações / Análise de Risco' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Operações / Análise de Risco
Sidebar ativo: "Risco"
Referência: 3134:3458
...
PageSection/KPI Row: 3415:34634 — COMPONENT_SET (Default/With Percent/With Icon)
