...
const _existing = figma.currentPage.children.find(n => n.name === "Admin / Settings / Process & Rules");
if (_existing) { _existing.remove(); console.log("Removed existing frame: Admin / Settings / Process & Rules"); }

// 
// STEP 1 — Frame principal 1440x880
// 
const screen = figma.createFrame();
screen.name = "Admin / Settings / Process & Rules";
...
if (bc) await tryFont(bc, "Process & Rules");
...
const _screen = figma.currentPage.children.find(n => n.name === "Admin / Settings / Process & Rules");
if (!_screen) throw new Error("Frame 'Admin / Settings / Process & Rules' nao encontrado — execute STEP 0-4 primeiro");
...
```
Frame criado: Admin / Settings / Process & Rules
Sidebar ativo: "Settings"
Referência: 3134:3183
